...
1. Add Cloud Event Sources: 
    - Using the [Kubernetes API Server Source file](https://knative.dev/docs/eventing/sources/apiserversource/getting-started/#create-an-apiserversource-object) already in the root directory, apply the APIServerSource resource with: 
